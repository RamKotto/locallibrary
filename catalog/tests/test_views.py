...
class AuthorListViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 13 authors for pagintaion test
        number_of_authors = 13
        for author_num in range(number_of_authors):
            Author.objects.create(first_name = 'Christy %s' % author_num,
                                  last_name = 'Golden %s' % author_num)
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            status = 'm'
            BookInstance.objects.create(book=test_book,imprint='Unlikely Imprint, 2020',
